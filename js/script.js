...
var siteHistory = {
	...
	bindClickEvents:function(){
		$('a').live('click',function(){
			...
			var _url = $(this).attr('href');
			if (_url.indexOf('bakbio.cn') != -1 && $(this).hasClass('no-ajax') == false) {
	...
	pageChange:function(_url){
		...
		_newUrl = _url;
		var analyticsUrl = _newUrl.replace("http://bakbio.cn", "");
